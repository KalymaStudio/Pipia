...
<div class="product-description">
    ...
    {block name='product_reference'}
        {if $product.reference != ''}
            <div class="product-reference text-muted"> <a href="{$product.canonical_url}">{$product.reference}</a></div>{/if}
    {/block}
    ...
    {block name='product_price_and_shipping'}
        {if $product.show_price}
            <div class="product-price-and-shipping">
                ...
                <a href="{$product.canonical_url}"> <span  class="product-price" content="{$product.price_amount}">{$product.price}</span></a>
