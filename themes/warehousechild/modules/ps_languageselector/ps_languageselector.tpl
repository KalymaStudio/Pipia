    ...
    <div class="language-selector-wrapper d-inline-block">
        <div class="language-selector js-dropdown">
            ...
            {foreach from=$languages item=language}
              <a href="{url entity='language' id=$language.id_lang}" rel="alternate" hreflang="{$language.iso_code}" data-iso-code="{$language.iso_code}"
               class="lang-item {if $language.id_lang == $current_language.id_lang}current {/if}"> {$language.iso_code}</a> <span class="sep">|</span>
            {/foreach}
