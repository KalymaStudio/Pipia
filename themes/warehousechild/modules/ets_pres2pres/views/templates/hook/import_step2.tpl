...
<div class="form-group">
    ...
    <div class="col-lg-12">
        ...
        {if isset($assign['employees']) && $assign['employees'] && in_array('employees',$export_datas)}
            <div class="checkbox">
                ...
                <label for="data_import_employees">
                    <input{if in_array('employees',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="employees" type="checkbox" id="data_import_employees" />
                    <span class="data_checkbox_style">
                    <i class="icon icon-check"></i>
                    </span>{l s='Employees' mod='ets_pres2pres'}
                </label> 
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if isset($assign['manufactures']) && $assign['manufactures'] && in_array('manufactures',$export_datas)}
            <div class="checkbox">
                <div class="items_left col-xs-6 col-sm-6">
                    <label for="data_import_manufactures"><input{if in_array('manufactures',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="manufactures" type="checkbox" id="data_import_manufactures" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Manufacturers' mod='ets_pres2pres'}
                    </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if isset($assign['suppliers']) && $assign['suppliers'] && in_array('suppliers',$export_datas)}
            <div class="checkbox">
                <div class="items_left col-xs-6 col-sm-6">
                    ...
                    <input{if in_array('suppliers',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="suppliers" type="checkbox" id="data_import_suppliers" />
                    <span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Suppliers' mod='ets_pres2pres'}
                    </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if isset($assign['carriers']) && $assign['carriers'] && in_array('carriers',$export_datas)}
            <div class="checkbox">
                <div class="items_left col-xs-6 col-sm-6">
                <label for="data_import_carriers"><input{if in_array('carriers',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="carriers" type="checkbox" id="data_import_carriers" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Carriers & shipping prices' mod='ets_pres2pres'}
                </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if $pres_version==1.4}
            {if isset($assign['vouchers']) && $assign['vouchers'] && in_array('vouchers',$export_datas)}
                <div class="checkbox">
                    <div class="items_left col-xs-6 col-sm-6">
                    <label for="data_import_vouchers"><input{if in_array('vouchers',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="vouchers" type="checkbox" id="data_import_vouchers" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Vouchers' mod='ets_pres2pres'}
                    </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {else}
            {if isset($assign['cart_rules']) && $assign['cart_rules'] && in_array('cart_rules',$export_datas)}
                <div class="checkbox">
                    <div class="items_left col-xs-6 col-sm-6">
                    <label for="data_import_cart_rules"><input{if in_array('cart_rules',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="cart_rules" type="checkbox" id="data_import_cart_rules" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Cart rules' mod='ets_pres2pres'}
                    </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
            ...
            {if isset($assign['catelog_rules']) && $assign['catelog_rules'] && in_array('catelog_rules',$export_datas)}
                <div class="checkbox">
                    <div class="items_left col-xs-6 col-sm-6">
                    <label for="data_import_catelog_rules"><input{if in_array('catelog_rules',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="catelog_rules" type="checkbox" id="data_import_catelog_rules" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Catalog rules' mod='ets_pres2pres'}
                    </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if isset($assign['orders']) && $assign['orders'] && in_array('orders',$export_datas)}
            <div class="checkbox">
                <div class="items_left col-xs-6 col-sm-6">
                <label for="data_import_orders"><input{if in_array('orders',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="orders" type="checkbox" id="data_import_orders" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Orders & shopping carts' mod='ets_pres2pres'}
                </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if isset($assign['CMS_categories']) && $assign['CMS_categories'] && in_array('CMS_categories',$export_datas)}
            <div class="checkbox">
                <div class="items_left col-xs-6 col-sm-6">
                <label for="data_import_CMS_categories"><input{if in_array('CMS_categories',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="CMS_categories" type="checkbox" id="data_import_CMS_categories" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='CMS categories' mod='ets_pres2pres'}
                </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if isset($assign['CMS']) && $assign['CMS'] && in_array('CMS',$export_datas)}
            <div class="checkbox">
                <div class="items_left col-xs-6 col-sm-6">
                <label for="data_import_CMS"><input{if in_array('CMS',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="CMS" type="checkbox" id="data_import_CMS" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='CMSs' mod='ets_pres2pres'}
                </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
        ...
        {if isset($assign['messages']) && $assign['messages'] && in_array('messages',$export_datas)}
            <div class="checkbox">
                <div class="items_left col-xs-6 col-sm-6">
                <label for="data_import_messages"><input{if in_array('messages',$ets_pres2pres_import)} checked="checked"{/if} name="data_import[]" value="messages" type="checkbox" id="data_import_messages" /><span class="data_checkbox_style"><i class="icon icon-check"></i></span>{l s='Contact form messages' mod='ets_pres2pres'}
                </label>
                </div>
                <div class="items_right col-xs-6 col-sm-6">
