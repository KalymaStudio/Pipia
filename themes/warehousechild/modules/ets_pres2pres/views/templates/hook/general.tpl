...
<div class="page_general">
    <div class="breadcrum_migrate">
        <div class="breadcrum_migrate_content">
            ...
            {if isset($intro) && $intro && isset($general_tab) && $general_tab}
                <ul class="other-modules-ul">{include file="./other.tpl"}</ul>
            {/if}
        </div>
    </div>
    ...
    <div class="dtm-right-block">
        ...
        <div class="step4_right col-sm-6">
            <div class="data-format-to-import">
                            ...
                            <div class="items_right col-xs-4 col-sm-4">
                                ...
                                <div class="status_help">
                                    ...
                                    <div class="status_help_pop">
                                        {l s='300 seconds is recommended' mod='ets_pres2pres'}
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="items_right col-xs-4 col-sm-4">
                                ...
                                <div class="status_help">
                                    <i class="fa fa-question-circle"></i>
                                    <div class="status_help_pop">
                                        {l s='512 MB is recommended' mod='ets_pres2pres'}
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="items_right col-xs-4 col-sm-4">
                                ...
                                <div class="status_help">
                                    <i class="fa fa-question-circle"></i>
                                    <div class="status_help_pop">
                                        {l s='3000 is recommended' mod='ets_pres2pres'}
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div class="alert alert-info center_icon">
