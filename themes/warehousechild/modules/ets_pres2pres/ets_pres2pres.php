...
class Ets_pres2pres extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Prestashop Migrator');
    ...
    public function processImportdata14()
    {
        ...
        if (in_array('employees', $datas_import) && !in_array('employees', explode(',', $import_history['import_active']))) {
            ...
            $import_history['import_active'] .= 'employees,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        ...
        if (in_array('manufactures', $datas_import) && !in_array('manufactures', explode(',', $import_history['import_active']))) {
            $import->importData14('Manufacturer', 'Manufacturer');
            $import_history['import_active'] .= 'manufactures,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        if (in_array('suppliers', $datas_import) && !in_array('suppliers', explode('suppliers', $import_history['import_active']))) {
            $import->importData14('Supplier', 'Supplier');
            $import_history['import_active'] .= 'suppliers,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        ...
        if (in_array('carriers', $datas_import) && !in_array('carriers', explode(',', $import_history['import_active']))) {
            ...
            $import_history['import_active'] .= 'carriers,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        if (in_array('vouchers', $datas_import) && !in_array('vouchers', explode(',', $import_history['import_active']))) {
            $import->importData14('Discount', 'Discount');
            $import_history['import_active'] .= 'vouchers,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        ...
        if (in_array('orders', $datas_import) && !in_array('orders', explode(',', $import_history['import_active']))) {
            ...
            $import_history['import_active'] .= 'orders,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        if (in_array('CMS_categories', $datas_import) && !in_array('CMS_categories', explode(',', $import_history['import_active']))) {
            $import->importData14('CMSCategory', 'CMSCategory');
            $import_history['import_active'] .= 'CMS_categories,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        if (in_array('CMS', $datas_import) && !in_array('CMS', explode(',', $import_history['import_active']))) {
            ...
            $import_history['import_active'] .= 'CMS,';
            Db::getInstance()->execute('UPDATE ' . _DB_PREFIX_ . 'ets_pres2pres_import_history SET import_active="' . pSQl($import_history['import_active']) . '" WHERE id_import_history=' . (int)$id_import_history);
        }
        if (in_array('messages', $datas_import) && !in_array('messages', explode(',', $import_history['import_active']))) {
    ...
    public function processImportdata()
    {
        ...
        if (in_array('employees', $datas_import) && !in_array('employees', explode(',', $import_history['import_active']))) {
            ...
            $this->setImportActive(($import_history['import_active'] .= 'employees,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        ...
        if (in_array('manufactures', $datas_import) && !in_array('manufactures', explode(',', $import_history['import_active']))) {
            ...
            $this->setImportActive(($import_history['import_active'] .= 'manufactures,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        if (in_array('suppliers', $datas_import) && !in_array('suppliers', explode(',', $import_history['import_active']))) {
            $import->importData('Supplier', 'Supplier', Supplier::$definition, array(), $multishop);
            $this->setImportActive(($import_history['import_active'] .= 'suppliers,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        ...
        if (in_array('carriers', $datas_import) && !in_array('carriers', explode(',', $import_history['import_active']))) {
            ...
            $this->setImportActive(($import_history['import_active'] .= 'carriers,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        ...
        if (in_array('cart_rules', $datas_import) && !in_array('cart_rules', explode(',', $import_history['import_active']))) {
            ...
            $this->setImportActive(($import_history['import_active'] .= 'cart_rules,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        if (in_array('catelog_rules', $datas_import) && !in_array('catelog_rules', explode(',', $import_history['import_active']))) {
            $import->importData('SpecificPriceRule', 'SpecificPriceRule', SpecificPriceRule::$definition, array(), $multishop);

            $this->setImportActive(($import_history['import_active'] .= 'catelog_rules,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        if (in_array('orders', $datas_import) && !in_array('orders', explode(',', $import_history['import_active']))) {
            ...
            if (version_compare(_PS_VERSION_, '1.6.1', '>=')) {
                ...
                $import->importData('Customization', 'Customization', Customization::$definition, $foreign_key_customization, $multishop);
            ...
            $this->setImportActive(($import_history['import_active'] .= 'orders,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        if (in_array('CMS_categories', $datas_import) && !in_array('CMS_categories', explode(',', $import_history['import_active']))) {
            ...
            $this->setImportActive(($import_history['import_active'] .= 'CMS_categories,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        if (in_array('CMS', $datas_import) && !in_array('CMS', explode(',', $import_history['import_active']))) {
            ...
            $this->setImportActive(($import_history['import_active'] .= 'CMS,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        if (in_array('page_cms', $datas_import) && !in_array('page_cms', explode(',', $import_history['import_active']))) {
            $foreign_key_cms = array(
                'id_cms_category' => array(
                    'table_parent' => 'cms_category',
                    'key' => 'id_cms_category'
            ...
            $this->setImportActive(($import_history['import_active'] .= 'page_cms,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
        if (in_array('messages', $datas_import) && !in_array('messages', explode(',', $import_history['import_active']))) {
            ...
            $this->setImportActive(($import_history['import_active'] .= 'messages,'));
            die(Tools::jsonEncode(array(
                'wait' => true,
            )));
        }
    ...
    public function cleanForderImported($id_history)
    {
        ...
        if (in_array('employees', $data_exports)) {
            $countEmployee = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_employee_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
                'title' => $this->l('Employees:'),
                'count' => $countEmployee,
                'count_xml' => (int)$xml->countemployee,
            );
            if (file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Employee.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Employee_' . $currentindex . '.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Employee_1.xml'))
                $ok = false;
        }
        ...
        if (in_array('orders', $data_exports)) {
            $countOrder = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_orders_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
                'title' => $this->l('Orders:'),
                'count' => $countOrder,
                'count_xml' => (int)$xml->countorder,
            );
            if (file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/OrderHistory.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/OrderHistory_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/OrderHistory_' . $currentindex . '.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Order.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Order_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Order_' . $currentindex . '.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/OrderDetail.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/OrderDetail_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/OrderDetail_' . $currentindex . '.xml'))
                $ok = false;
        }
        if (in_array('manufactures', $data_exports)) {
            $countManufacturer = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_manufacturer_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
                'title' => $this->l('Manufacturers:'),
                'count' => $countManufacturer,
                'count_xml' => (int)$xml->countmanufacturer,
            );
            if (file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Manufacturer.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Manufacturer_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Manufacturer_' . $currentindex . '.xml'))
                $ok = false;
        }
        if (in_array('suppliers', $data_exports)) {
            $countSupplier = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_supplier_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
                'title' => $this->l('Suppliers:'),
                'count' => $countSupplier,
                'count_xml' => (int)$xml->countsupplier,
            );
            if (file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Supplier.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Supplier_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Supplier_' . $currentindex . '.xml'))
                $ok = false;
        }
        if (in_array('carriers', $data_exports)) {
            $countCarrier = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_carrier_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
                'title' => $this->l('Carriers'),
                'count' => $countCarrier,
                'count_xml' => (int)$xml->countcarrier,
            );
            if (file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Carrier.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Carrier_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Carrier_' . $currentindex . '.xml'))
                $ok = false;
        }
        if (in_array('cart_rules', $data_exports)) {
            if ($this->pres_version > 1.4) {
                $countCartRule = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_cart_rule_import where id_import_history="' . (int)$import['id_import_history'] . '"');
                $contents[] = array(
        ...
        if (in_array('catelog_rules', $data_exports)) {
            if ($this->pres_version > 1.4) {
                $countSpecificPriceRule = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_specific_price_rule_import where id_import_history="' . (int)$import['id_import_history'] . '"');
                $contents[] = array(
        ...
        if (in_array('CMS_categories', $data_exports)) {
            $countCMSCategory = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_cms_category_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
        ...
        if (in_array('CMS', $data_exports)) {
            $countCMS = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_cms_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
                'title' => $this->l('CMSs:'),
                'count' => $countCMS,
        ...
        if (in_array('messages', $data_exports)) {
            $countMessage = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_customer_thread_import where id_import_history="' . (int)$import['id_import_history'] . '"');
            $contents[] = array(
                'title' => $this->l('Contact form messages:'),
                'count' => $countMessage,
                'count_xml' => (int)$xml->countmessage,
            );
            if (file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/CustomerThread.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/CustomerThread_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/CustomerThread_' . $currentindex . '.xml'))
                $ok = false;
        }
        if (in_array('vouchers', $data_exports)) {
            if ($this->pres_version == 1.4) {
                $countVoucher = Db::getInstance()->getValue('SELECT count(*) FROM ' . _DB_PREFIX_ . 'ets_pres2pres_discount_import where id_import_history="' . (int)$import['id_import_history'] . '"');
                $contents[] = array(
            ...
            if ((file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Discount.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Discount_1.xml') || file_exists(dirname(__FILE__) . '/xml/' . $import['file_name'] . '/Discount_' . $currentindex . '.xml')))
                $ok = false;
        }
        $this->context->smarty->assign(
            array(
